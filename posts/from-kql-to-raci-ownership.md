...
**[Download the Azure RACI Matrix](https://gumroad.com/l/raci-template?ref=cost-recovery-loop)** to close the loop between detection and deletion.

<div class="downloads" style="text-align: center; margin-top: 2rem;">
  <a class="btn" href="https://gumroad.com/l/raci-template?ref=cost-recovery-loop" style="font-size: 1.2em; padding: 15px 30px; background-color: #0078d4; color: white;">Get the Execution RACI</a>
